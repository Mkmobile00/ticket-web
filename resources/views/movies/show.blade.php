...
@php
    ...
    $posterImg = $movie->poster_image
        ? (str_starts_with($movie->poster_image, 'assets/') ? asset($movie->poster_image) : asset('storage/' . $movie->poster_image))
        : asset('assets/images/movie/venus.jpg');
    $duration = $movie->duration_minutes
        ? floor($movie->duration_minutes / 60) . ' hrs ' . ($movie->duration_minutes % 60) . ' mins'
        : '';
@endphp

@section('content')
<!-- ==========Banner-Section========== -->
    <section class="details-banner bg_img" data-background="{{ $bannerImg }}">
        <div class="container">
    ...
    <section class="book-section bg-one">
        <div class="container">
            <div class="book-wrapper offset-lg-3">
                <div class="left-side">
                    <div class="item">
                        <div class="item-header">
                            ...
                            <div class="counter-area">
                                <span class="counter-item odometer" data-odometer-final="{{ (int) $movie->rating_tomato }}">0</span>
                            </div>
                        </div>
                        <p>tomatometer</p>
                    </div>
                    <div class="item">
                        <div class="item-header">
                            ...
                            <div class="counter-area">
                                <span class="counter-item odometer" data-odometer-final="{{ (int) $movie->rating_audience }}">0</span>
                            </div>
                        </div>
                        <p>audience Score</p>
                    </div>
                    <div class="item">
                        <div class="item-header">
                            <h5 class="title">{{ number_format($movie->user_rating ?? 0, 1) }}</h5>
                            <div class="rated">
                ...
                <a href="{{ route('movies.showtimes', $movie->slug) }}" class="custom-button">book tickets</a>
            </div>
        </div>
    </section>
    <!-- ==========Book-Section========== -->
            ...
            <div class="row justify-content-center flex-wrap-reverse mb--50">
                <div class="col-lg-3 col-sm-10 col-md-6 mb-50">
                    <div class="widget-1 widget-tags">
                        <ul>
                            @forelse ($movie->formats as $format)
                                <li><a href="#0">{{ $format->name }}</a></li>
                            @empty
                                <li><a href="#0">2D</a></li>
                            @endforelse
                        </ul>
                        ...
                        <div class="details-photos owl-carousel">
                            <div class="thumb">
                                <a href="{{ asset('assets/images/movie/movie-details01.jpg') }}" class="img-pop">
                                    <img src="{{ asset('assets/images/movie/movie-details01.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ asset('assets/images/movie/movie-details02.jpg') }}" class="img-pop">
                                    <img src="{{ asset('assets/images/movie/movie-details02.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ asset('assets/images/movie/movie-details03.jpg') }}" class="img-pop">
                                    <img src="{{ asset('assets/images/movie/movie-details03.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ asset('assets/images/movie/movie-details01.jpg') }}" class="img-pop">
