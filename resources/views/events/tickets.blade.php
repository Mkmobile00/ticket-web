...
@section('content')
<!-- ==========Banner-Section========== -->
    <section class="details-banner event-details-banner hero-area bg_img seat-plan-banner" data-background="{{ asset('assets/images/banner/banner07.jpg') }}">
        <div class="container">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-md-6 col-lg-4 col-sm-10">
                    <div class="ticket--item">
                        <div class="ticket-thumb">
                            <img src="{{ asset('assets/images/event/ticket/ticket01.png') }}" alt="event">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-sm-10">
                    <div class="ticket--item two">
                        ...
                        <div class="ticket-thumb">
                            <img src="{{ asset('assets/images/event/ticket/ticket02.png') }}" alt="event">
                        </div>
                        <div class="ticket-content">
                ...
                <div class="col-md-6 col-lg-4 col-sm-10">
                    <div class="ticket--item three">
                        <div class="ticket-thumb">
                            <img src="{{ asset('assets/images/event/ticket/ticket03.png') }}" alt="event">
                        </div>
                        <div class="ticket-content">
