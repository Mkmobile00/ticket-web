...
<!-- ==========Event-Banner-Section========== -->
    <section class="event-banner-section bg_img" data-background="{{ asset('assets/images/banner/banner06.jpg') }}">
        <div class="container">
            <div class="event-banner">
                @if ($event->trailer_embed_url)
                    <a href="{{ $event->trailer_embed_url }}" class="video-popup">
                        <span></span>
    ...
    <section class="event-book-search padding-top pt-lg-0">
        <div class="container">
            <div class="event-search bg_img" data-background="{{ asset('assets/images/ticket/ticket-bg01.jpg') }}">
                    ...
                    <div class="contact-side">
                        <div class="item">
                            <div class="item-thumb">
                                <img src="{{ asset('assets/images/event/icon/event-icon01.png') }}" alt="event">
                            </div>
                        ...
                        <div class="item">
                            <div class="item-thumb">
                                <img src="{{ asset('assets/images/event/icon/event-icon02.png') }}" alt="event">
                            </div>
                            <div class="item-content">
                        ...
                        <div class="item">
                            <div class="item-thumb">
                                <img src="{{ asset('assets/images/event/icon/event-icon03.png') }}" alt="event">
                            </div>
                            <div class="item-content">
            ...
            <div class="row justify-content-between flex-wrap-reverse">
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="event-about-thumb">
                        <img src="{{ asset('assets/images/event/event-about.jpg') }}" alt="event">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row m-0">
                    ...
                    <div class="col-sm-6 p-0">
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="{{ asset('assets/images/gallery/gallery01.jpg') }}" class="img-pop">
                                    <i class="flaticon-loupe"></i>
                                </a>
                                <img src="{{ asset('assets/images/gallery/gallery01.jpg') }}" alt="gallery">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 p-0">
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="{{ asset('assets/images/gallery/gallery02.jpg') }}" class="img-pop">
                                    <i class="flaticon-loupe"></i>
                                </a>
                                <img src="{{ asset('assets/images/gallery/gallery02.jpg') }}" alt="gallery">
                            </div>
                        </div>
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="{{ asset('assets/images/gallery/gallery03.jpg') }}" class="img-pop">
                                    <i class="flaticon-loupe"></i>
                                </a>
                                <img src="{{ asset('assets/images/gallery/gallery03.jpg') }}" alt="gallery">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 p-0">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <a href="{{ asset('assets/images/gallery/gallery04.jpg') }}" class="img-pop">
                            <i class="flaticon-loupe"></i>
                        </a>
                        <img src="{{ asset('assets/images/gallery/gallery04.jpg') }}" alt="gallery">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ==========Statistics-Section========== -->
    <section class="statistics-section padding-top padding-bottom bg_img pb-lg-0" data-background="{{ asset('assets/images/statistics/statistics-bg01.jpg') }}">
        <div class="container">
            <div class="section-header-3">
            ...
            <div class="statistics-wrapper">
                <div class="row mb--20">
                    <div class="col-md-4">
                        <div class="stat-item">
                            <div class="stat-thumb">
                                <img src="{{ asset('assets/images/statistics/stat01.png') }}" alt="statistics">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="stat-item">
                            <div class="stat-thumb">
                                <img src="{{ asset('assets/images/statistics/stat02.png') }}" alt="statistics">
                            </div>
                            <div class="stat-content">
                    ...
                    <div class="col-md-4">
                        <div class="stat-item">
                            <div class="stat-thumb">
                                <img src="{{ asset('assets/images/statistics/stat03.png') }}" alt="statistics">
                            </div>
                            <div class="stat-content">
                    ...
                    <div class="tab-item active">
                        <div class="owl-theme owl-carousel sponsor-slider">
                            <div class="sponsor-thumb">
                                <a href="#0">
                                    <img src="{{ asset('assets/images/sponsor/1.png') }}" alt="sponsor">
                                </a>
                            </div>
                            <div class="sponsor-thumb">
                                <a href="#0">
                                    <img src="{{ asset('assets/images/sponsor/2.png') }}" alt="sponsor">
                                </a>
                            </div>
                            <div class="sponsor-thumb">
                                <a href="#0">
                                    <img src="{{ asset('assets/images/sponsor/3.png') }}" alt="sponsor">
                                </a>
                            </div>
                            <div class="sponsor-thumb">
                                <a href="#0">
                                    <img src="{{ asset('assets/images/sponsor/4.png') }}" alt="sponsor">
                                </a>
                            </div>
                            <div class="sponsor-thumb">
                                <a href="#0">
                                    <img src="{{ asset('assets/images/sponsor/5.png') }}" alt="sponsor">
                                </a>
                            </div>
                        </div>
                    </div>
