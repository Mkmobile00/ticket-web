    ...
    <section class="apps-seciton padding-top pt-lg-0">
        <div class="container">
            <div class="apps-wrapper bg-six padding-top padding-bottom">
                <div class="bg_img apps-bg" data-background="{{ asset('assets/images/apps/apps01.png') }}"></div>
                    ...
                    <div class="col-lg-7 offset-lg-5">
                        <div class="content">
                            ...
                            <ul class="app-button">
                                <li>
                                    <a href="#0">
                                        <img src="{{ asset('assets/images/apps/apps03.png') }}" alt="apps">
                                    </a>
                                </li>
                                <li>
                                    <a href="#0">
                                        <img src="{{ asset('assets/images/apps/apps02.png') }}" alt="apps">
                                    </a>
                                </li>
                            </ul>
                        </div>
