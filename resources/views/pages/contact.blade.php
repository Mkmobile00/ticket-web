                ...
                <div class="row justify-content-between">
                    <div class="col-md-7 col-lg-6 col-xl-5">
                        <div class="section-header-3 left-style">
                            ...
                            <p>Weâ€™d love to talk about how we can work together. Send us a message below and weâ€™ll respond as soon as possible.</p>
                        </div>
                        @if (session('status'))
                        ...
                        <form class="contact-form" method="POST" action="{{ route('contact.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Your Full Name" name="name" value="{{ old('name') }}" id="name" required>
                            </div>
                            <div class="form-group">
                                <label for="email">Email <span>*</span></label>
                                <input type="email" placeholder="Enter Your Email" name="email" value="{{ old('email') }}" id="email" required>
                            </div>
                            <div class="form-group">
                                <label for="subject">Subject <span>*</span></label>
                                <input type="text" placeholder="Enter Your Subject" name="subject" value="{{ old('subject') }}" id="subject">
                            </div>
                            <div class="form-group">
